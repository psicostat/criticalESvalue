...
eqs <- data.frame(
  ...
  Model = c("One-sample t-test",
            ...
            "Correlation test","Correlation","Meta-analysis/Regression"),
  ...
  Equation = c("$d_c = \\frac{t_c \\times \\mbox{SE}_b}{s} = t_c\\sqrt{\\frac{1}{n}}$",
               "$d_c = \\frac{t_c \\times \\mbox{SE}_b}{s_p}$",
               "$d_{z_c} = \\frac{t_c \\times \\mbox{SE}_b}{s_D} = t_c\\sqrt{\\frac{1}{n}}$",
               "$d_c = \\frac{t_c \\times \\mbox{SE}_b}{s_p} = t_c\\sqrt{\\frac{1}{n_1} + \\frac{1}{n_2}}$",
               "$r_c = \\frac{t_c}{\\sqrt{n - 2 + t^2_c}}$","$r_{z_c} = \\frac{z_c}{\\sqrt{n - 3}}$",
               "$\\beta_c = t_c \\times \\mbox{SE}_{\\beta}$")
)
