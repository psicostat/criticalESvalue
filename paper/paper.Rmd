...
Beyond critical effect size values, researchers should reason before conducting a study on what conclusions can be drawn with their experimental design, and for those cases where sample size constrains will make it impossible to find significance for a plausible effect because it is likely smaller than the critical effect size value, alternative options for data collection, such as multisite studies [@sirois2023pupil; @moshontz2018psychological; @jarke2022roadmap; @byers2020building], should be explored.
