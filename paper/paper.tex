...
Beyond critical effect size values, researchers should reason before conducting a study on what conclusions can be drawn with their experimental design, and for those cases where sample size constrains will make it impossible to find significance for a plausible effect because it is likely smaller than the critical effect size value, alternative options for data collection, such as multisite studies (Byers-Heinlein et al., 2020; Jarke et al., 2022; Moshontz et al., 2018; Sirois et al., 2023), should be explored.
